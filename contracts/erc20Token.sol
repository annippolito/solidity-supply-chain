...
contract ERC20Token is ERC20Interface {
    ...
    // Return the current balance (in tokens) of that specidied owner's address
    function balanceOf(address _owner) public view returns (uint256 balance) {
        return balances[_owner];
    }

    // Set the allowed spending (ex: Max is able to spend this amount _value for the address _spender)
    ...
    // Return the allowance, how much a specific account is allowed to spend on a specific spender ?
